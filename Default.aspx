...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container" style="margin-top:6%">
        <div class="row">
            <div class="col-lg-12">
                <asp:Image ID="imgBus" ImageAlign="AbsMiddle" ImageUrl="~/img/R.jpeg" style="width:100%" runat="server" />
            </div>
            <div class="col-lg-12" style="margin-top:2%">
                <div class="panel panel-default">
                    <div class="panel-heading">
                         <div class=" panel-title">
                        <h3>Introduction About BusBuddy</h3>
                    </div>
                       </div>
                    <div class="panel-body">
                        <p style="font-size:large">
                            &nbsp;BusBuddy is a
                            Online Bus Booking System. It is Web Based application,That works with in centralised network,It Provides facility to 
