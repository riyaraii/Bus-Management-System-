                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                       ...
                       <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtMobileNo" 
                                ValidationGroup="vgRegister" CssClass="text-danger" ErrorMessage="Enter 10 digit no" ValidationExpression="\d{10}"></asp:RegularExpressionValidator>
                            <br />
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtEmailID" 
                                ValidationGroup="vgRegister" CssClass="text-danger"
                                ErrorMessage="ENTER PROPER EMAIL" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                            <br />
                        </div>
                        <div class="form-group">
